...
public class BlockNexus4 extends Block {
	...
	public void onBlockClicked(World worldIn, BlockPos pos, EntityPlayer playerIn) {
		...
		if(!worldIn.isRemote) {
			Minecraft.getMinecraft().player.sendMessage(new TextComponentString(TextFormatting.GREEN + "The Nexus is attacked!"));	
	...
	public void onBlockDestroyedByPlayer(World worldIn, BlockPos pos, IBlockState state) {
    	...
    	if(!worldIn.isRemote) {
			Minecraft.getMinecraft().player.sendMessage(new TextComponentString(TextFormatting.GREEN + "The Nexus is destroyed!"));	
    	}
	}	
	...
	public void onBlockAdded(World worldIn, BlockPos pos, IBlockState state) {
		...
		if(!worldIn.isRemote) {
			Minecraft.getMinecraft().player.sendMessage(new TextComponentString(TextFormatting.GREEN + "The Nexus is placed!"));	
		}
	}	
