...
public class BlockToxicNailTrap extends Block {
	...
	public void onEntityCollidedWithBlock(World worldIn, BlockPos pos, IBlockState state, Entity entityIn) {
		if (entityIn instanceof EntityPlayer && !worldIn.isRemote) {
			...
			player.addPotionEffect(new PotionEffect(MobEffects.POISON, 150, 0));
		...
		if (entityIn instanceof EntityLiving && !worldIn.isRemote) {
			...
			entity.addPotionEffect(new PotionEffect(MobEffects.POISON, 150, 0));
