...
public class GuiTableOfAges extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        fontRenderer.drawString(tileEntityTableOfAges.getName(), 10, 5, Color.darkGray.getRGB());
        fontRenderer.drawString("Inventory", 95, 130, Color.darkGray.getRGB());
        fontRenderer.drawString("Storage", 112, 90, Color.darkGray.getRGB());
    }
