...
public class ItemCompoundBow extends ItemBow {
	...
	public ItemCompoundBow() {
...

	        {
	            ...
	            {
	                return entityIn == null ? 0.0F : (entityIn.getActiveItemStack().getItem() != ModItems.compoundBow ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 30.0F);   //20 = default speed
	            }
	        });
