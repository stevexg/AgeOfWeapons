...
public class ItemHerobrineBow extends ItemBow {
	...
	public ItemHerobrineBow() {
...

	        {
	            ...
	            {
	                return entityIn == null ? 0.0F : (entityIn.getActiveItemStack().getItem() != ModItems.herobrineBow ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 10.0F);   //20 = default speed
	            }
	        });
      ...
      if (entityLiving instanceof EntityPlayer)
      {
          ...
          if (!itemstack.isEmpty() || flag)
          {
              if (itemstack.isEmpty())
              {
                 ...
                 float f = (float) i / 10.0F;    // <- schnelleres aufladen (crit)
  ...
  @Override
	public void onUpdate(ItemStack stack, World world, Entity entity, int i, boolean bool) {
		...
		if(stack.isItemEnchanted() == false) {
			...
			stack.addEnchantment(Enchantments.PUNCH, 0);
