...
public class ItemLongbow extends ItemBow {
	...
	public ItemLongbow() {
...

	        {
	            ...
	            {
	                return entityIn == null ? 0.0F : (entityIn.getActiveItemStack().getItem() != ModItems.longbow ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 25.0F);   //20 = default speed
	            }
	        });
