...
public class ItemCrossbow extends ItemBow {
	...
	public ItemCrossbow() {
...

	        {
	            ...
	            {
	                return entityIn == null ? 0.0F : (entityIn.getActiveItemStack().getItem() != ModItems.crossbow ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 30.0F);   //20 = default speed
	            }
	        });
          ...
          if (!itemstack.isEmpty() || flag)
          {
              ...
              if ((double)f >= 0.1D)
              {
                  ...
                  if (!worldIn.isRemote)
                  {
                      ...
                      entityarrow.shoot(entityplayer, entityplayer.rotationPitch, entityplayer.rotationYaw, 0.0F, 5.0F, 0.0F);
