...
public class ItemLightBow extends ItemBow {
	...
	public ItemLightBow() {
...

	        {
	            ...
	            {
	                return entityIn == null ? 0.0F : (entityIn.getActiveItemStack().getItem() != ModItems.lightBow ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 10.0F);   //20 = default speed
	            }
	        });
