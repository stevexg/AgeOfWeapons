...
public class ItemShadowBow extends ItemBow {
	...
	public ItemShadowBow() {
...

	        {
	            ...
	            {
	                return entityIn == null ? 0.0F : (entityIn.getActiveItemStack().getItem() != ModItems.shadowBow ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 10.0F);   //20 = default speed
	            }
	        });
