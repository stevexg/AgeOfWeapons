...
public class ItemWarhornOffensive extends Item {
	
	public ItemWarhornOffensive () {
		super();
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
	    ...
	    if(!worldIn.isRemote) {        
	    	...
	    	cloud1.addEffect(new PotionEffect(MobEffects.STRENGTH, 5000, 0));
	    	cloud1.addEffect(new PotionEffect(MobEffects.HASTE, 5000, 0));
