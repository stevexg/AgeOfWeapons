...
public class ItemThrowWood extends ItemBow {
	...
	public ItemThrowWood() {
	     ...
	     //   this.setCreativeTab(ModTabs.stoneAgeTab);			WIP
	        ...
	        
	        {
	            ...
	            {
	                return entityIn == null ? 0.0F : (entityIn.getActiveItemStack().getItem() != ModItems.throwWood ? 0.0F : (float)(stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 10.0F);   //20 = default speed
	            }
	        });
  ...
  public void onPlayerStoppedUsing(ItemStack stack, World worldIn, EntityLivingBase entityLiving, int timeLeft)
  {
      if (entityLiving instanceof EntityPlayer)
      {
          ...
          if (!itemstack.isEmpty() || flag)
          {
              ...
              {
                  itemstack = new ItemStack(ModItems.throwWood);
              }
