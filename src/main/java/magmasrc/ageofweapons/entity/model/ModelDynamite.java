...
/**                  old 3D model
 ...
 public ModelDynamite()  {
     ...
     e1 = new ModelRenderer(this, 0, 9);
     e1.addBox(7.5F, 0F, 7.5F, 1, 6, 1);
     e1.setRotationPoint(7.5F, 0F, 7.5F);
     e1.setTextureSize(64, 64);
     e1.mirror = false;
     setRotation(e1, 0F, 0F, 0F);
     e2 = new ModelRenderer(this, 0, 6);
     e2.addBox(7.5F, 6F, 8F, 2, 2, 1);
     e2.setRotationPoint(7.5F, 6F, 8F);
