...
public class EntityPrimedNeutronBomb extends Entity
{
    private static final DataParameter<Integer> FUSE = EntityDataManager.<Integer>createKey(EntityPrimedNeutronBomb.class, DataSerializers.VARINT);
    @Nullable
    private EntityLivingBase tntPlacedBy;
    /** How long the fuse is */
    private int fuse;

    public EntityPrimedNeutronBomb(World worldIn){
        super(worldIn);
        this.fuse = 80;
    ...
    public EntityPrimedNeutronBomb(World worldIn, double x, double y, double z, EntityLivingBase igniter) {
        this(worldIn);
