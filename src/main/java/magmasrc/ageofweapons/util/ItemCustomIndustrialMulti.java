...
public class ItemCustomIndustrialMulti extends ItemTool {
	...
	public ItemCustomIndustrialMulti(int breakr, int breakd, float attackDamage, ToolMaterial material, Set effectiveBlocks, String hartool, int harlevel, float attackSpeed) {
		...
		if(!world.isRemote) {
			...
			if(block.removedByPlayer(blockstate, world, pos, player, true)) {
				...
				if(!player.capabilities.isCreativeMode) {
					block.harvestBlock(world, player, pos, blockstate, null, player.getActiveItemStack()); 
